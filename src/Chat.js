...
const Chat = () => {
  const [messages, setMessages] = useState([
    {
      sender: "bot",
      text: "Olá! Como posso ajudá-lo hoje? Sou um assistente em comércio exterior e posso ajudar com informações sobre tarifas, regulamentações e muito mais.",
    },
  ]);
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          sender: "bot",
          text: "Estou com problemas de conexão. Por favor, tente novamente mais tarde.",
        },
      ]);
